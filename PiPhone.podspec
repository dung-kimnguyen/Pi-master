...
PiPhone is a drop in solution to support picture-in-picture (user-initiated playback of video in a floating, resizable window) on iPhone devices.
  ...
  s.homepage         = 'https://github.com/nocero.beguhe/PiPhone'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'nocero.beguhe' => 'nocero.beguhe@mail.com' }
  s.source           = { :git => 'https://github.com/nocero.beguhe/PiPhone.git', :tag => s.version.to_s }
